...
enum index_enum { program_name = 0, input_argument_name_1 = 1, expected_number_of_command_line_arguments = 2, input_argument_name_2 = 3 };
...
enum main_enum { MAIN_DRAW = 1, MAIN_QUIT = 2 };